...
class LogHistory:
    ...
    def loghistory():
        ...
        cursor.execute('SELECT LOGHISTORY.PK_ID, LOGHISTORY.FK_ID_FARMER, LOGHISTORY.FK_ID_DISEASE, LOGHISTORY.URL_IMAGE, FARMER.PK_ID, PLANTDISEASE.PK_ID, PLANTDISEASE.PLANT_DISEASE '
        +'FROM LOGHISTORY '
